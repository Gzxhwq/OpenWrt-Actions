...
sed -i "s|amlogic_firmware_repo.*|amlogic_firmware_repo 'https://github.com/Gzxhwq/OpenWrt-Actions'|g" package/others/luci-app-amlogic/luci-app-amlogic/root/etc/config/amlogic
