...
sed -i '$a src-git passwall_packages https://github.com/Gzxhwq/openwrt-passwall;tuic-client' feeds.conf.default
...
sed -i '$a src-git passwall_luci https://github.com/Gzxhwq/openwrt-passwall;tuic' feeds.conf.default
